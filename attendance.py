...
class Attendance:
    def __init__(self,root):
        ...
        btn_frame.place(x=0,y=300,width=690,height=40)

        #save button
        save_btn=Button(btn_frame,width=15,text="Import csv",command=self.importCSV,font=("times new roman",12,"bold"),bg="Black",fg="white")
        save_btn.grid(row=0,column=0,padx=10)

        #update button
        update_btn=Button(btn_frame,width=15,command=self.exportCSV,text="Export csv",font=("times new roman",12,"bold"),bg="Black",fg="white")
        update_btn.grid(row=0,column=1,padx=10)

        #delete button
        delete_btn=Button(btn_frame,width=15,text="Update",font=("times new roman",12,"bold"),bg="Black",fg="white")
        ...
        self.AttendanceReportTable=ttk.Treeview(table_frame,columns=("id","roll","name","department","date","time","attendance"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
    ...
    def exportCSV(self):
        try:
            ...
            with open(fln,mode="w",newline="") as myfile:
                ...
                messagebox.showinfo("Success","Data sucessfully exported to "+os.path.basename(fln)+".")
